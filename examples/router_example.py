...
def main():
    ...
    for i, (timestamp, pnl, description) in enumerate(trades, 1):
        ...
        total = (decision.base_capital_after + decision.flow_buffer_after +
                 decision.convexity_buffer_after)
    ...
    if config.flow_buffer_cap:
        ...
        print("  Flow Buffer:       No cap")

    print("  Convexity Buffer:  No cap")
    print()
